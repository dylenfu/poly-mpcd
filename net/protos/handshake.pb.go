...
// source: net/protos/handshake.proto
...
// HandshakeEnvelop contains a mashalled protocol message, as well as a signature
// over the contents of the message(to ensure an advansary hasn't tempared with the content)
type HandshakeEnvelop struct {
	Message   []byte `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
	Signature []byte `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty"`
	PeerID    []byte `protobuf:"bytes,3,opt,name=peerID,proto3" json:"peerID,omitempty"`
}

func (m *HandshakeEnvelop) Reset()      { *m = HandshakeEnvelop{} }
func (*HandshakeEnvelop) ProtoMessage() {}
func (*HandshakeEnvelop) Descriptor() ([]byte, []int) {
	return fileDescriptor_b43903ad3ae5fea5, []int{0}
}
func (m *HandshakeEnvelop) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HandshakeEnvelop) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HandshakeEnvelop.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *HandshakeEnvelop) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HandshakeEnvelop.Merge(m, src)
}
func (m *HandshakeEnvelop) XXX_Size() int {
	return m.Size()
}
func (m *HandshakeEnvelop) XXX_DiscardUnknown() {
	xxx_messageInfo_HandshakeEnvelop.DiscardUnknown(m)
}

var xxx_messageInfo_HandshakeEnvelop proto.InternalMessageInfo

func (m *HandshakeEnvelop) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
func (m *HandshakeEnvelop) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *HandshakeEnvelop) GetPeerID() []byte {
	if m != nil {
		return m.PeerID
	}
	return nil
...
func (*Act1Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_b43903ad3ae5fea5, []int{1}
}
...
func (*Act2Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_b43903ad3ae5fea5, []int{2}
}
...
func (*Act3Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_b43903ad3ae5fea5, []int{3}
}
...
func init() {
	proto.RegisterType((*HandshakeEnvelop)(nil), "net.HandshakeEnvelop")
...
func init() { proto.RegisterFile("net/protos/handshake.proto", fileDescriptor_b43903ad3ae5fea5) }

var fileDescriptor_b43903ad3ae5fea5 = []byte{
	// 266 bytes of a gzipped FileDescriptorProto
	,
	...
	0x3c, 0x96, 0x63, 0x88, 0x62, 0x2a, 0x48, 0x4a, 0x62, 0x03, 0x5b, 0x68, 0x0c, 0x08, 0x00, 0x00,
	0xff, 0xff, 0xa2, 0x73, 0x21, 0x2d, 0x94, 0x01, 0x00, 0x00,
}

func (this *HandshakeEnvelop) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HandshakeEnvelop)
	if !ok {
		that2, ok := that.(HandshakeEnvelop)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *HandshakeEnvelop) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&pb.HandshakeEnvelop{")
...
func (m *HandshakeEnvelop) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *HandshakeEnvelop) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HandshakeEnvelop) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *HandshakeEnvelop) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *HandshakeEnvelop) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HandshakeEnvelop{`,
...
func (m *HandshakeEnvelop) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: HandshakeEnvelop: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HandshakeEnvelop: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
